 ...
 */
// 请求url路径
Window.pathUrl = 'http://' + window.location.host + '/';
// 图片地址
Window.mediaPath = 'http://192.168.0.122/resource/wjpmedia/';
(function($) {
